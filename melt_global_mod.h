...
#ifndef _aspect_material_model_melt_global_mod_h
#define _aspect_material_model_melt_global_mod_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class MeltGlobalMod : public MaterialModel::MeltInterface<dim>, public ::aspect::SimulatorAccess<dim>, public MaterialModel::MeltFractionModel<dim>
    {
    public:
      /**
       * Defines that the MeltGlobalMod model is incompressible.
       */
    ...
    private:
      ...
      double dT_solidus_liquidus;
      double dC_solidus_liquidus;
      ...
      /*const double T00=1373.0;
      const double Tlim0=923.0; //923.0;
      const double Tknee=2.0; //200.0; //10.0;
      const double CWmax=10.0;
